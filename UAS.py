...
input_bahasa = ["Semoga kita sehat selalu",
	"Shpirt, mund të jemi të suksesshëm.",
	"Må vi alltid vara friska.",
	"Mögen wir immer gesund sein.",
	"私たちは常に健康です。",
	"Mag ons altyd gesond wees."]
...
for data in input_bahasa:
    ...
    sentence = [list_bahasa.get(language_code), language_code, data]
